...
namespace AdysTech.IISLogAnalytics
{
    class Program
    {
        ...
        private static int CollectionToTable(Dictionary<string, MethodInfo> collection, int reportRow, int reportCol, string Title)
        {
            ...
            {
                reportRow++; reportCol = 1;
                reportSheet.Cells[reportRow, reportCol++] = i.Value.Url;
                reportSheet.Cells[reportRow, reportCol++] = i.Value.Hits;
                reportSheet.Cells[reportRow, reportCol++] = i.Value.MinResponseTime;
                reportSheet.Cells[reportRow, reportCol++] = i.Value.AvgResponseTime;
                reportSheet.Cells[reportRow, reportCol++] = i.Value.MaxResponseTime;
                reportSheet.Cells[reportRow, reportCol++] = i.Value.NinetiethPercentile;
                reportSheet.Cells[reportRow, reportCol++] = i.Value.Median;
                reportSheet.Cells[reportRow, reportCol++] = i.Value.StandardDeviation;
            }
